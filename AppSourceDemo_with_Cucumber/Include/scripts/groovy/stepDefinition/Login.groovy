...
class Login {
	...
	public void user_input_registered_username_only(String username) {
		Mobile.callTestCase(findTestCase('Pages/User Login/Input Username'), [('username') : username], FailureHandling.STOP_ON_FAILURE)
	...
	public void user_see_products_title_page(String title) {
		Mobile.callTestCase(findTestCase('Pages/Products/Read Page Title'), [('expected') : title], FailureHandling.STOP_ON_FAILURE)
	}
}